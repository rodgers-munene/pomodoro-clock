      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          ...
          <div id="session-length" class="timer-set">
            <button class="btn btn-light" id="session-increment" onClick={(e) => {props.increment(e, "session")}}>+</button>
            <span class="num">{props.sessionTime}</span>
            <button class="btn btn-light" id="session-decrement" onClick={(e) => {props.decrement(e, "session")}}>-</button>
          </div>
        </div>
        <div class="col-md-6">
          <div id="break-label">
          ...
          <div id="break-length" class="timer-set">
            <button class="btn btn-light" id="break-increment" onClick={(e) => {props.increment(e, "break")}}>+</button>
            <span class="num">{props.breakTime}</span>
            <button class="btn btn-light" id="break-decrement" onClick={(e) => {props.decrement(e, "break")}}>-</button>
          </div>
        </div>
      </div>
    </div>
